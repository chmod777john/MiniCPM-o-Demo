...
The vendored ``modeling.o5`` package is the code/config source. Runtime weights
are a complete safetensors bundle. Tokenizer/processor and Token2Wav assets are
resolved separately because a published weight bundle does not have to contain
those runtime assets.
"""
